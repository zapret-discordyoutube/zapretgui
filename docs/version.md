...
### Стабильные версии
Стабильные (релизные) сборки поставляются через лаунчер [`Zapret2Setup.exe`](https://git.zapret.moe/zapretdiscordyoutube/zapretgui/releases/tag/21.1.1.5).
...
Обновления по ним доступны только через [Forgejo](https://git.zapret.moe/zapretdiscordyoutube/zapretgui/releases) или Telegram-канал — нужно скачать новую сборку вручную.

### Консольные версии (без GUI, Win7)
Подробнее тут: https://git.zapret.moe/zapretdiscordyoutube/zapretgui/releases/tag/win7
