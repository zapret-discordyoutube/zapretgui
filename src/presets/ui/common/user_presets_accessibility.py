    ...
    *,
    ...
    set_control_accessibility(
        ...
        description=tr_fn(
            ...
            (
                "Стрелки вверх и вниз выбирают пресет, "
                "Enter или Пробел активирует пресет или сворачивает и разворачивает папку, "
                "Ctrl со стрелкой вверх или вниз перемещает пресет, "
                "пресет также можно перетащить мышью, клавиша меню открывает действия"
            ),
        ),
    )
    try:
